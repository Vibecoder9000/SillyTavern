    ...
    if (online_status === 'no_connection' && power_user.auto_connect) {
        switch (main_api) {
            ...
            case 'textgenerationwebui':
                ...
                break;
            case 'openai':
                if ((secret_state[SECRET_KEYS.OPENAI_CODEX_OAUTH] && oai_settings.chat_completion_source == chat_completion_sources.OPENAI_CODEX)
                    ...
                    || (isValidUrl(oai_settings.antseed_endpoint) && oai_settings.chat_completion_source == chat_completion_sources.ANTSEED)
